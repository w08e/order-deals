...
//		return StringUtil.random(count, RandomTypeEnum.ALL);
//	}
...
//	}
	...
	public static String getContainsStr(CharSequence str, CharSequence... testStrs) {
		if (isEmpty(str) || Objects.isNull(testStrs)) {
			return null;
		}
...
//		if (ObjectUt.hasEmpty(content, strForSearch) || strForSearch.length() > content.length()) {
//			return 0;
//		}
//
//		int count = 0;
